...
ggsave('plots/pVisTime.pdf', insettedVisTime, width = 3.2, height = 3, units = 'in' )
...
p <- cowplot::plot_grid(NULL, pDistEig,pInVOut+theme(legend.position='none'),  ncol = 3, rel_widths = c(.45, 1,1), labels = c('e', 'f','g'))
p
